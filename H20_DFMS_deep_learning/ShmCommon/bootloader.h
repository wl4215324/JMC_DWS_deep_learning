...
#define  BT_RESULT_SAVE_FILE  "/extp/BT_mode"
...
extern int bootloader_logic_init();

extern int bootloader_main_process(const unsigned char* can_mesg, unsigned short mesg_len, \
