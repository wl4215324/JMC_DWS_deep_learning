...
#define AW_MEMION_IOC_IMPORT		_IOWR(AW_MEM_ION_IOC_MAGIC, 5, struct aw_ion_fd_data)
#define AW_MEMION_IOC_SYNC		_IOWR(AW_MEM_ION_IOC_MAGIC, 7, struct aw_ion_fd_data)
