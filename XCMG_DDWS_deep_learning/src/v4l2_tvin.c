	...
	for (i = 0; ; i++)
	{
...
#endif
		{
			...
			case 4:  //calling phone
				strcpy(disp_str, "phone");
				break;

			case 5:  // smoking warning
				strcpy(disp_str, "smoke");
				break;

			case 8:  //level one closed-eye warning
			case 9:  //level two closed-eye warning
				strcpy(disp_str, "closeeye");
				break;
			}

			disp_str_on_monitor(40, 10, disp_str, local_gray_image);
