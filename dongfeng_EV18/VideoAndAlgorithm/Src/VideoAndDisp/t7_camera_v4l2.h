...
#define  DSM_CAMERA_INDEX  0
#define  MONITOR_CAMERA_INDEX 1
...
extern unsigned char picture_is_ready;
extern pthread_mutex_t picture_lock;
extern pthread_cond_t picture_cond;
