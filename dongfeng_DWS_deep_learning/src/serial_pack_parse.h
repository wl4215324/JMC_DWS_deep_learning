...
#define MESSAGE_ID_OF_TURN_SIGNAL  0x0CFDCC32
...
#define MESSAGE_ID_OF_ENGINE_SPEED_INDEX  56

#define MESSAGE_ID_OF_SMALL_LAMP  0x18FF2732
#define MESSAGE_ID_OF_SMALL_LAMP_INDEX  68

#define MESSAGE_ID_OF_DRIVER_DOOR  0x18FF2232
...
typedef struct {
	...
	*/
	...
	unsigned char warning_sub_state;
	unsigned char left_bytes[6];
...
extern unsigned char vehicle_speed_judge_flag;
